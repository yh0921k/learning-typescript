...
function asyncFunction02(data1) {
    return Promise.resolve(30 + data1);
}
function asyncFunction03(data1, data2) {
    return Promise.resolve(data1 + data2);
}
function getDataPromise() {
    asyncFunction01()
        .then(function (data1) { return Promise.all([data1, asyncFunction02(data1)]); })
        .then(function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data1 = _a.sent();
                    return [4 /*yield*/, asyncFunction02(data1)];
                case 2:
                    data2 = _a.sent();
                    return [2 /*return*/, asyncFunction03(data1, data2)];
            }
        });
    });
}
